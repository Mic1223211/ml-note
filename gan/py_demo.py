...
for iter in range(num_epoch):
    ...
    grad_r_w1 = grad_G_w1_part_3.T.dot(grad_r_w1_part_1*grad_r_w1_part_2)
    ...
    grad_G_b1 = grad_G_w1_part_1*grad_G_w2_part_2

    # update gradient
    m5 = beta_1 *m5 + (1-beta_1)*grad_G_w1
    v5 = beta_2 *v5 + (1-beta_2)*grad_G_w2 **2
    ...
    if iter%10 == 0:
        ...
        fig.savefig('gan_image',bbox_inches='tight')
