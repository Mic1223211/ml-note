...
def dynamicRNN(x,seqlen,weights,biases):
    ...
    #Get lstm cell output,providing 'sequence length' will perform dynamic
    #Calculation
    outputs,states = tf.contrib.rnn.static_rnn(lstm_cell,x,dtype=tf.float32,sequence_length=seqlen)
    #When performing dynamic calculation, we must retrieve the last
    #dynamically computed output, i.e. , if a sequence length is 10,we
    #need to retrieve the 10 th output
