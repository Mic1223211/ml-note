...
num_input = 784
num_classes = 10
dropout = 0.25 # drop,probability to drop a unit
...
def conv_net(x_dict,n_classes,dropout,reuse,is_training):
    ...
    with tf.variable_scope('ConvNet',reuse=reuse):
        ...
        # Apply Dropout (if is_training is False, dropout iis not applied)
...
def model_fn(features,labels,mode):
    ...
    #need to create a distinct computation graphs that still share the same weights
    ...
    #The different ops for training, evaluate, ...
